...
tests =
    ...
    , checkPredicate "run a 2nd successful game trace"
        ...
        $ do
            successTrace
            Trace.payToWallet w2 w3 gameTokenVal
            Trace.waitNSlots 1
            hdl3 <- Trace.activateContractWallet w3 G.contract
            Trace.callEndpoint @"guess" w3 hdl3 GuessArgs{guessArgsOldSecret="new secret", guessArgsNewSecret="hello", guessArgsValueTakenOut=Ada.lovelaceValueOf 4}
